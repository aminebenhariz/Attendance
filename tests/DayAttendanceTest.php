...
class DayAttendanceTest extends \PHPUnit_Framework_TestCase
{
     ...
     * @param DayAttendance $dayAttendance
     */
    public function testGetDate(DayAttendance $dayAttendance)
    {
        $this->assertSame('2015-12-12', $dayAttendance->getDate());
    }
     ...
     * @param DayAttendance $dayAttendance
     */
    public function testGetTimeLine(DayAttendance $dayAttendance)
    {
        $this->assertSame(
            '08:30 (10:00-10:15) (12:30-13:30) (16:00-16:15) 17:30',
            $dayAttendance->getTimeLine()
        );
    }
}
